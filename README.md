...
My stack:
Frontend:
HTML5 CSS3 Less SASS React Redux Ant-Design MUI TypeScript Next JS

Backend:
NodeJS Express.js Postgres Sequelize

Plan to learn:
Prisma Apollo-GraphQL Type-graphql NestJS Vercel Heroku

Like to use:
Codewars MDN Web Docs Visual Studio Code Google Chrome
